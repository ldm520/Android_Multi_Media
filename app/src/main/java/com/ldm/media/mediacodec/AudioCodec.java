package com.ldm.media.mediacodec;
...
public class AudioCodec {
    private static final String TAG = "LDM_MEDIA";
    ...
    public static void getPCMFromAudio(String audioPath, String audioSavePath, final AudioDecodeListener listener) {
        ...
        try {
            ...
            if (hasAudio) {
                ...
                //原始音频解码
                ThreadPoolsUtils.execute(new AudioDecodeRunnable(extractor, audioTrack, audioSavePath, new DecodeOverListener() {
                    @Override
    ...
    public static void PcmToAudio(String pcmPath, String audioPath, final AudioDecodeListener listener) {
        ThreadPoolsUtils.execute(new AudioEncodeRunnable(pcmPath, audioPath, new AudioDecodeListener() {
            @Override
